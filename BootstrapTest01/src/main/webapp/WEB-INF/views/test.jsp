			...
			<!-- Nested Container Starts -->
				...
				<!-- Top Links Starts -->
					<ul class="list-unstyled list-inline header-links mb-0 float-sm-left">
						<li class="list-inline-item"><a href="index.html"><i class="fa fa-home d-block d-lg-none" title="Home"></i><span class="d-none d-lg-block">Home</span></a></li>
				...
				<!-- Nested Row Starts -->
					...
					<!-- Logo Starts -->
						<div class="col-xl-6 col-md-4 col-sm-12 text-center">
							<div id="logo"><a href="index.html"><img src="images/logo.png" title="Electro Shoppe" alt="Electro Shoppe" class="img-fluid" /></a></div>
						</div>
					<!-- Logo Starts -->	
				...
				<!-- Navbar Cat collapse Starts -->
					<div class="collapse navbar-collapse navbar-cat-collapse">
						<ul class="nav navbar-nav">
							<li class="nav-item"><a href="category-list.html" class="nav-link">Digital Cameras</a></li>
							<li class="nav-item dropdown">
								<a href="category-list.html" class="nav-link dropdown-toggle" data-toggle="dropdown">
									Sound Devices
								</a>
								<div class="dropdown-menu rounded-0">
									<a href="#" class="dropdown-item">Music System</a>
									<a href="#" class="dropdown-item">DTS</a>
									<a href="#" class="dropdown-item">Home Theater</a> 
								</div>
							</li>
							<li class="nav-item dropdown">
							...
							<li class="nav-item"><a href="category-list.html" class="nav-link">Computers</a></li>
							<li class="nav-item"><a href="category-list.html" class="nav-link">Laptops</a></li>
							<li class="nav-item"><a href="category-list.html" class="nav-link">DSLR Cameras</a></li>
							<li class="nav-item"><a href="category-list.html" class="nav-link">Smart Phones</a></li>
							<li class="nav-item dropdown">
								<a href="category-list.html" class="nav-link dropdown-toggle" data-toggle="dropdown">
									Pages
								</a>
                        ...
                        <div class="list-group-item">
                            <div class="filter-group">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="defaultCheck1">Brand Name 1</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="">
                                    <label class="form-check-label" for="defaultCheck2">Brand Name 2</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="">
                                    <label class="form-check-label" for="defaultCheck3">Brand Name 3</label>
                                </div>
                            </div>
                        </div>
                        <div class="list-group-item">
                        ...
                        <div class="list-group-item">
                            <div class="filter-group">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="exampleRadios1">Manufacturer Name 1</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="option2">
                                    <label class="form-check-label" for="exampleRadios2">Manufacturer Name 2</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="option3">
                                    <label class="form-check-label" for="exampleRadios3">Manufacturer Name 3</label>
                                </div>
                            </div>							
                        </div>	
                        <div class="list-group-item">
